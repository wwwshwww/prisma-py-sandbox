...
class PostActions(Generic[_PrismaModelT]):
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Post record ordered by the id field
...
class PostTagActions(Generic[_PrismaModelT]):
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await PostTag.prisma().query_raw(
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await PostTag.prisma().query_first(
            'SELECT * FROM PostTag WHERE tagId = $1',
            'idfjadbcc',
        )
        ```
        """
    ...
    async def create(
        ...
        posttag = await PostTag.prisma().create(
            data={
    ...
    async def create_many(
        ...
        *,
        ...
        -------
        ```py
        total = await PostTag.prisma().create_many(
            data=[
                {
                    # data to create a PostTag record
                    'postId': 'bhhfibbigf',
    ...
    async def delete(
        ...
        -------
        ```py
        posttag = await PostTag.prisma().delete(
            where={
                # PostTag where unique filter
    ...
    async def find_unique(
        ...
        -------
        ```py
        posttag = await PostTag.prisma().find_unique(
            where={
                # PostTag where unique filter
    ...
    async def find_unique_or_raise(
        ...
        -------
        ```py
        posttag = await PostTag.prisma().find_unique_or_raise(
            where={
                # PostTag where unique filter
    ...
    async def find_many(
        ...
        posttags = await PostTag.prisma().find_many(take=10)

        # find the first 5 PostTag records ordered by the postId field
        posttags = await PostTag.prisma().find_many(
            take=5,
            order={
                'postId': 'desc',
            },
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second PostTag record ordered by the tagId field
        posttag = await PostTag.prisma().find_first(
            skip=1,
            order={
                'tagId': 'desc',
            },
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second PostTag record ordered by the postId field
        posttag = await PostTag.prisma().find_first_or_raise(
            skip=1,
            order={
                'postId': 'desc',
            },
    ...
    async def update(
        ...
        -------
        ```py
        posttag = await PostTag.prisma().update(
            where={
                # PostTag where unique filter
    ...
    async def upsert(
        ...
        -------
        ```py
        posttag = await PostTag.prisma().upsert(
            where={
                # PostTag where unique filter
            },
            data={
                'create': {
                    # PostTag data to be set if the record does not exist
                },
                'update': {
                    # PostTag data to be set if the record does exist
                },
            },
        )
        ```
    ...
    async def update_many(
        ...
        total = await PostTag.prisma().update_many(
            data={
                'tagId': 'chbfcacbd'
            },
            where={}
    ...
    async def count(
        ...
        ```py
        # total: int
        total = await PostTag.prisma().count()

        # results: prisma.types.PostTagCountAggregateOutput
        results = await PostTag.prisma().count(
            select={
                '_all': True,
                'postId': True,
            },
    ...
    async def delete_many(
        ...
        total = await PostTag.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            method='delete_many',
    ...
    async def group_by(
        self,
        by: List['types.PostTagScalarFieldKeys'],
        *,
        where: Optional['types.PostTagWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        ...
        order: Optional[Union[Mapping['types.PostTagScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.PostTagScalarFieldKeys', 'types.SortOrder']]]] = None,
        ...
        -------
        ```py
        # group PostTag records by postId values
        # and count how many records are in each group
        results = await PostTag.prisma().group_by(
            ['postId'],
            count=True,
        )
        ```
